...
export const MEMBERS_ONLY_ABI = [
  ...
  'function reveal()',
  'function revealUpTo(uint256 maxCount)',
  'function revealPending() view returns (uint256)',
  'function revealCursor() view returns (uint256)',
  'function mintedInBlock(uint256 tokenId) view returns (uint64)',
  'function commonLeft() view returns (uint256)',
  'function rareLeft() view returns (uint256)',
  'function legendaryLeft() view returns (uint256)',
  'function COMMON_SUPPLY() view returns (uint256)',
  'function RARE_SUPPLY() view returns (uint256)',
  'function LEGENDARY_SUPPLY() view returns (uint256)',
  'function preRevealURI() view returns (string)',
  'function setPreRevealURI(string uri)',
